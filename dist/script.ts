class Ship {
    type: any = {                   // TODO: set data type of 'type'
        Carrier: 5,
        Battleship: 4,
        Cruiser: 3,
        Destroyer: 2
...
class Game {
    ...
    botCells: NodeListOf<HTMLTableCellElement> = document.querySelectorAll('.player_cells_empty');
    humanCells: NodeListOf<HTMLTableCellElement> = document.querySelectorAll('.bot_cells_empty');


    constructor() {
        let humanBoard = new Board(this.human, [
        ...
        let botBoard = new Board(this.bot, [
